	...
	nameMng(QString("Device Names"))
{
	...
	dCmp = new DepracatedComponent( depType,"F11","02F011x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F11N","02F011x");
	lstDepracatedModules.add( dCmp );
	...
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z029_CAN","16Z029_CAN");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z029_CAN_IO","16Z029_CAN");
	lstDepracatedModules.add( dCmp );
	...
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z001_SMB","16Z001_SMB");
	lstDepracatedModules.add( dCmp );
