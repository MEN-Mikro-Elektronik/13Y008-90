	...
	nameMng(QString("Device Names"))
{
	...
	swMod = new SwModule( type, "hwbug", "HWBUG/program.mak",
	...
	DepracatedComponent *dCmp;
	DepracatedComponent::DepracatedType depType;
	depType = DepracatedComponent::EOS;
	dCmp = new DepracatedComponent( depType,"F11S","02F011x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F14","02F014");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F17","02F017");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F18","02F018");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F19P_F19C","02F019P");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F21P_F21C","02F021P");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F22P","02F022P");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F23P","02F023P");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"G20","02G020");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"G22","02G022");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D9","02D009");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM9","15EM09");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"MM50","15MM50");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"PP1","15PP01");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"KAHLUA_BOX_MMOD","KAHLUA_BOX_x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"KAHLUA_BOX_PCMIP","KAHLUA_BOX_x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"KAHLUA_BOX_PMC","KAHLUA_BOX_x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"MM1","15MM01");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"XM2","15XM02");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A12a","01A012a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A12b","01A012a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A12c","01A012a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A15a","01A015a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A15b","01A015a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A15c","01A015a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"B11","01B011");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A19","01A019");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A20","01A020");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A17","01A017");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A21_MSI_b","01A021");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A21b","01A021");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A21c","01A021");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"Bx50x","09BL50/09BC50 (08SC24)");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"Bx70x","09BL70/09BC70 (08SC25)");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"DC13","09DC13 (08SC27)");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"DC15","09DC15 (08SC24)");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D202","02D202");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F206","02F206");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F207","02F207");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F405","02F405");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z024_SRAM","16Z024_SRAM");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z025_UART","16Z025_UART");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z044_FB","16Z044_DISP");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z050_BIO","16Z050_BIOC");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z050_BIO_IO","16Z050_BIOC");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z051_DAC","16Z051_DAC");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z051_DAC_IO","16Z051_DAC");
	lstDepracatedModules.add( dCmp );
	...
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z076_QSPI","16Z076_QSPI");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z076_QSPI_DMA","16Z076_QSPI");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z076_QSPI_EM1A05","16Z076_QSPI");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z073_QDEC","16Z073_QDEC");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z077_ETH","16Z077_ETH");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z082_IMPULSE","16Z082_IMPULSE");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z082_IMPULSE_IO","16Z082_IMPULSE");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"16Z140_FREQ","16z140_FREQUENCY");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M22","04M022");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M24","04M024");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M27","04M027");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M28","04M028");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M34","04M034");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M45","04M045N");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M51","04M051");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M54","04M054");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M65_L2","04M065");
	lstDepracatedModules.add( dCmp );
	...
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M76","04M076");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M77","04M077");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M77N","04M077N");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M78","04M078");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M79","04M079");
	lstDepracatedModules.add( dCmp );

	depType = DepracatedComponent::EOL;
	dCmp = new DepracatedComponent( depType,"A11","01A011");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A13a","01A013a/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A13c","01A013a/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A14a","01A014");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A14c","01A014");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"A22","01A022");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"BE10","09BE10");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F7","02F007");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F9","02F009");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F13","02F013");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F15","02F015");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F1","02F001");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F2","02F002");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F6","02F006");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F12","02F012");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F12N","02F012");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"G40","02G040");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"G51","02G051");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"G52","02G052");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F50P","02F050");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D2","02D002");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D3a","02D003a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D3b","02D003a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D3c","02D003a/b/c");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D4_PMC","02D004");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D4_PCMIP","02D004");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D6","02D006");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D7","02D007");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM2","15EM02");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM3","15EM03");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM5","15EM05");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM7","15EM07x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM7N","15EM07x");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"EM8","15EM08");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"XM1","15XM01");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F201","02F201");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F202","02F202");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F203","02F203");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"F223","02F223");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D201","02D201");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D302","02D302");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"D602","02D602");
	lstDepracatedModules.add( dCmp );
	...
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M8","04M008");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M13","04M013");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M15","04M015");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M16","04M016");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M29","04M029");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M30","04M030");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M35","04M035");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M39","04M039");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M41","04M041");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M44","04M044");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M49","04M049");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M50","04M050");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M55","04M055");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M56","04M056");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M59","04M059");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M60","04M060");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M61","04M061");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M63","04M063");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M67","04M067");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M68","04M068");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M70","04M070");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M74","04M074");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"M97","04M097");
	lstDepracatedModules.add( dCmp );
	dCmp = new DepracatedComponent( depType,"MS9N","04MS09N");
	lstDepracatedModules.add( dCmp );
}
